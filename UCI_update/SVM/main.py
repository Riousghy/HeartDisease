...
import subprocess
import pandas as pd
from model_training import train_and_optimize_svm  # Updated to include optimization function
...
def main():
    ...
    # Step 3: Train and optimize SVM model
    train_and_optimize_svm(data)
